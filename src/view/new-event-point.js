...
export default class NewEventPoint extends AbstractStatefulView {
  ...
  #datepickerTo = null;
  #handelSave = null;
  #handelCloseClick = null;

  constructor({point, destinations, offers, onSave, onClose}){
    super();
    ...
    this._setState(NewEventPoint.parsePointToState({point}));
    this.#handelCloseClick = onClose;
  ...
  #formSubmitHandler = (evt) => {
    evt.preventDefault();
    this.#handelSave(NewEventPoint.parseStateToPoint(this._state));
  };
